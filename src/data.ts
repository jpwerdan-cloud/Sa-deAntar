...
export const TRANSLATIONS = {
  BR: {
    ...
    authorsLabel: "Invetigadores Principais",
    ...
    contactTitle: "Conexão Antártica",
    contactSub: "Entre em contato com nossa equipe arquivística ou envie consultas acadêmicas sobre as coletas comportamentais e científicas.",
    contactName: "Nome Completo",
    contactEmail: "Endereço de E-mail",
    contactSubject: "Assunto do Contato",
    contactMsg: "Mensagem Literária / Consulta",
...
export const VIDEO_ITEMS: VideoItem[] = [
  {
    id: 'v4',
    youtubeId: "z2p-K4vA5hY",
    title: {
      BR: "Byers: No Limite Glaciar",
      EN: "Byers Peninsula: Frozen Field Camps",
      ES: "Península Byers: Estación Volante Extrema"
    },
    description: {
      BR: "O cotidiano rústico dos acampamentos científicos. O distanciamento físico e a autossuficiência levadas aos níveis extremos.",
      EN: "Fieldwork inside hostile shelter units. Human dynamics under severe isolation away from the main base benefits.",
      ES: "Operaciones en campamentos rústicos. Psicología de campo, adaptación de carpas y subsistencia biológica."
    },
    duration: "15:40",
    operation: 44,
    subcategory: "Acampamento",
    tags: ["acampamento", "expedição", "isolamento", "coping"],
    director: "Dr. Roberto Mendes",
    year: 2025,
    thumbnail: "https://images.unsplash.com/photo-1478131143081-80f7f84ca84d?q=80&w=800",
    isFilm: false
  },
  {
    id: 'v5',
    ...
    title: {
      BR: "Psicologia Antártica e Saúde Mental no SaúdeAntar",
      EN: "Antarctic Psychology and Mental Health dynamically in SaúdeAntar",
      ES: "Psicología Antártica y Salud Mental en SaúdeAntar"
    },
    description: {
  ...
  },
  {
    ...
    title: {
      BR: "A Vida nos Limites do Frio: Conectividade e Saúde Mental",
      EN: "Living on the Edge of extreme Cold: Connectivity & Well-being",
      ES: "La Vida en los Límites del Frío: Conectividad y Salud Mental"
    },
    description: {
    ...
    year: 2025,
    thumbnail: "https://images.unsplash.com/photo-1516055619834-586f8c75d1de?q=80&w=800",
    isFilm: false
  },
  {
    id: 'v7',
    ...
    director: "Dr. Roberto Mendes",
    year: 2024,
    thumbnail: "https://images.unsplash.com/photo-1518098268026-4e43a1a009de?q=80&w=800",
    isFilm: false
  },
  {
    id: 'v8',
