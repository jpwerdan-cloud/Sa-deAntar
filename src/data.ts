...
export const INTERVIEW_ITEMS: InterviewItem[] = [
  {
    ...
    fullTranscript: {
      BR: "Passar 5 meses na Estação Comandante Ferraz exige reconfigurar tudo o que sabemos sobre interações sociais. Em nossa pesquisa preliminar da Operação 42, percebemos que o 'efeito do terceiro trimestre' não é um mito. Ele surge quando a metade do percurso é superada e o fim do isolamento ainda parece inalcancável. É ali que descobrimos as estratégias maduras de resiliência que o cérebro humano consegue acionar para estabilizar a mente.",
